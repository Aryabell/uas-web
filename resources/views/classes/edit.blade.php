...
<div class="flex items-center justify-center min-h-screen bg-gray-100">
    <div class="w-full max-w-md relative bg-white p-6 rounded-lg shadow-lg">
        ...
        <h2 class="text-center text-2xl font-bold mb-4 text-[#052183]">Edit  Class</h2>
        ...
        <form action="{{ route('classes.update', $class->id) }}" method="POST" class="space-y-4">
            ...
            <!-- Title -->
            <div>
                <input type="text" class="form-control w-full p-2 mt-1 border rounded-lg" id="name" name="name" value="{{ $class->name }}" placeholder="Title" required>
            </div>

            <!-- Submit Button -->
            <button type="submit" class="w-full bg-[#052183] text-white p-2 rounded-lg hover:bg-blue-600 transition font-bold">Update Class</button>
